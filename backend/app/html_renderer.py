...
.resume-section {{ margin-top: {sm}mm; }} .resume-header + .resume-section {{ margin-top: 0; }} .resume-section h3 {{ margin: 0 0 .7mm; padding-bottom: .4mm; border-bottom: 1.5px solid #222; font-size: {section_font_size}pt; font-family: 'SimHei', 'Microsoft YaHei', sans-serif; }} .resume-section p {{ margin: {pm}mm 0; }} .resume-section p.subhead {{ margin: 1mm 0 .2mm; font-weight: 700; font-family: 'SimHei', 'Microsoft YaHei', sans-serif; }} .resume-paper strong {{ font-family: 'SimHei', 'Microsoft YaHei', sans-serif; font-weight: 700; }} .resume-item {{ margin: {im}mm 0; }} .resume-item-head {{ display: grid; grid-template-columns: 27% 46% 27%; gap: 1mm; font-family: 'SimHei', 'Microsoft YaHei', sans-serif; font-weight: 700; }} .resume-item-head strong:nth-child(2) {{ text-align: center; }} .resume-item-head strong:nth-child(3) {{ text-align: right; }} .resume-item-head.compact {{ display: flex; align-items: baseline; gap: 2mm; font-family: inherit; }} .resume-item-head.compact strong {{ white-space: nowrap; flex: 0 0 auto; }} .resume-item-head.compact span {{ text-align: left; font-weight: 400; font-family: inherit; }}
